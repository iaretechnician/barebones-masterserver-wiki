...
Note that this will trigger the error **Already logged In**. This is because in the script ScratchCreateGame we try to login again as guest. To remove the warning remove the lines 31 to 48.
---
